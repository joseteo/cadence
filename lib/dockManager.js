...
export class DockManager {
    ...
    start() {
        ...
        this._uiGroupIds.push(
            Main.uiGroup.connect('child-added', (_g, actor) => {
        ...
        this._uiGroupIds.push(
            Main.uiGroup.connect('child-removed', (_g, actor) => {
        ...
        this._settingIds.push(
            this._settings.connect('changed::show-on-all-monitors', () => this._sync())
        );
        this._settingIds.push(
            this._settings.connect('changed::widget-position', () => this._reinsertAll())
        );
    ...
    destroy() {
        for (const id of this._uiGroupIds) {
