...
export const Palette = {
    ...
    TitleOnDark: 'white',
    TitleOnLight: 'black',
    // The artist line is smaller and lighter than the title, so antialiasing eats
    // into its effective contrast: #cccccc measures well under the 4.5:1 floor on a
    // mid-tone card even though its nominal ratio looks acceptable. Keep the
    // hierarchy in the font size, not in a dimmer colour.
    ArtistOnDark: '#f7f7f7',
    ArtistOnLight: '#0a0a0a',
